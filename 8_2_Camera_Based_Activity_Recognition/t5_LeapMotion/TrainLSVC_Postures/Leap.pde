...
boolean checkFingers() {
  ...
  for (Hand hand : leap.getHands ()) {
    ...
    for (Finger finger : hand.getFingers()) {
      ...
      fingers[finger.getType()] = fingerPosition;
      // Drawing:
    ...
    float[] fingerDists = new float[sensorNum];
    fingerDists[0] = PVector.dist(fingers[0], fingers[1]);
    fingerDists[1] = PVector.dist(fingers[0], fingers[2]);
    fingerDists[2] = PVector.dist(fingers[0], fingers[3]);
    fingerDists[3] = PVector.dist(fingers[0], fingers[4]);
    fingerDists[4] = PVector.dist(fingers[1], fingers[2]);
    fingerDists[5] = PVector.dist(fingers[1], fingers[3]);
    fingerDists[6] = PVector.dist(fingers[1], fingers[4]);
    fingerDists[7] = PVector.dist(fingers[2], fingers[3]);
    fingerDists[8] = PVector.dist(fingers[2], fingers[4]);
    fingerDists[9] = PVector.dist(fingers[3], fingers[4]);
    ...
    showInfo("Predict: "+lastPredY, handPosition.x, handPosition.y, handPosition.z, 16);
  }
  return hasHand;
}
