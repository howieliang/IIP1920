...
void setup() {
  ...
  classifiers[0] = loadModelToClassifier(model="LSVR.model"); //load a pretrained model.
  classifiers[1] = loadModelToClassifier(model="KSVR.model"); //load a pretrained model.
  classifiers[2] = loadModelToClassifier(model="LinearReg.model"); //load a pretrained model.
}
void draw() {
  background(255);
